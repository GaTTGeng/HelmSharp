...
| [M3: Release Lifecycle Parity](https://github.com/GaTTGeng/HelmSharp/milestone/6) | Complete in 1.3.0 | Install, upgrade, rollback, uninstall, status, history, and hook behavior with durable revision transitions. |
