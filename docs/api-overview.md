...
1.3.1 is the latest published version. The M2 request objects, distribution workflows, and M3 lifecycle APIs on this page are available in the 1.3.1 NuGet packages.
:::
