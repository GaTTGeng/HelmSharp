...
The latest published version is **1.3.2**. The M2 chart-distribution and M3 release-lifecycle capabilities described below and in the linked guides are available in the 1.3.2 NuGet packages.
